...
public class RoleDaoImpl implements RoleDao {
    ...
    public Pagination<Role> findAllByPage(String param,int pagecount){
    	 String sql = "select id, role, description, resource_ids as resourceIdsStr, available from sys_role where 1=1 ";
     	...
     	Pagination<Role> page = new Pagination<Role>(sb.toString(), pagecount, list, Pagination.NUMBERS_PER_PAGE, jdbcTemplate,Role.class,"id");
     	return page;
    }
