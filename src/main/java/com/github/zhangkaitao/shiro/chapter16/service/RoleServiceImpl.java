...
public class RoleServiceImpl implements RoleService {
    ...
    public Map<String,Object> findAllRoleByPage(String param ,int pageCount){
    	Map<String,Object> map = new HashMap<String,Object>();
    	try {
    		Pagination<Role> page=roleDao.findAllByPage(param, pageCount);
    		map.put("page", page);
    		map.put("param", param);
		} catch (Exception e) {
			map.put("page", null);
    		map.put("param", null);
			System.out.println("角色分页异常"+e);
		}
    	return map;
    }
