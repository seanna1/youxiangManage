...
import com.github.zhangkaitao.shiro.chapter16.util.TranslateUtil;
...
public class TestController {
	...
	public static void main(String[] args) throws Exception {
        String appKey ="025146f9d891bf02";
        String query = "你好";
        String salt = String.valueOf(System.currentTimeMillis());
        String from = "zh-CHS";
        String to = "EN";
        String sign = md5(appKey + query + salt+ "kwLg1iSYnn8kP907vfPu45HVcdtAlGhE");
